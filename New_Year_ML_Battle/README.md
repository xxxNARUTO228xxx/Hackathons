...
Мы много эксперементировали с добавлением разных функций потерь, пробовали swin-transformer, но в итоге самым лучшем билдом оказался ViT, в котором мы почти ничего не трогали, а просто запустили "го бррр". х)
